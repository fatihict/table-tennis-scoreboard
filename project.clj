(defproject table-tennis-scoreboard "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "table_tennis_scoreboard.jar"
  ...
  :cljsbuild {:builds [{:id           "production"
                        ...
                        :compiler     {:asset-path    "js/prod"
                                       :main          table-tennis-scoreboard.client-main
                                       :optimizations :advanced
                                       :source-map    "resources/public/js/table_tennis_scoreboard.js.map"
                                       :output-dir    "resources/public/js/prod"
                                       :output-to     "resources/public/js/table_tennis_scoreboard.js"}}]}

  :profiles {:uberjar    {:main           table-tennis-scoreboard.server-main
                          :aot            :all
                          ...
                          :cljsbuild    {:builds
                                         [{:id           "dev"
                                          ...
                                          {:id           "test"
                                           ...
                                           :figwheel     {:on-jsload "table-tennis-scoreboard.client-test-main/client-tests"}
                                           :compiler     {:asset-path    "js/test"
                                                          :main          table-tennis-scoreboard.client-test-main
                                                          :optimizations :none
                                          ...
                                          {:id           "automated-tests"
                                           ...
                                           :compiler     {:asset-path    "js/ci"
                                                          :main          table-tennis-scoreboard.CI-runner
                                                          :optimizations :none
                                          ...
                                          {:id           "cards"
                                           ...
                                           :compiler     {:asset-path           "js/cards"
                                                          :main                 table-tennis-scoreboard.cards
                                                          :optimizations        :none
